...
VKBufferDownload::VKBufferDownload()
{
	m_memoryPropertyFlags = VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_CACHED_BIT;
}
VKBufferDownload::~VKBufferDownload()
{
}
...
{
	if (m_bufferCopy)
		VK_CHECK_RESULT(m_bufferCopy->invalidateHost(size));
}
